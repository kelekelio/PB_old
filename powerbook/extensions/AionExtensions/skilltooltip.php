...
include 'include/include_skill.php';
...
$cachefile = 'cache/skilltooltip/'.$language.'/'.$id . $cl .'.html';
$cachetime = 604800000;
//$cachetime = 1;
...
$query=mysqli_query($conn, $sql) or die(mysqli_error());
	...
	if ($id != NULL) {
		return skillIconBuilderMini($skillicon_name, isClassic()) . '  <a href="https://aionpowerbook.com/powerbook/Skill/' . $id . '">' . $localizationExtra . '</a>';
	}else {
		return '';
	}
}
...
$isTransform = TransformCheck($skillname);
if ($isTransform != NULL) {
	$isStigma = 6;
}
...
if ($deckoreanlive == $desckoreanfuture){
	...
	$descmissmattch = '<br><br><p style="color:red">(The description is in Korean because it doesn&apos;t match the 7.5 version)</p>';
	if (isClassic() == "1") {
		$descmissmattch = '<br><br><p style="color:red">(The description is in Korean because it doesn&apos;t match the selected localisation on record)</p>';
	}
	$desclong = translate($desc_long, 'ko');
...
if (isClassic() == "1") {
	...
	$descmissmattch .= '<br><p style="color:red">(The values might not be correct for the Classic Server)</p>';
}
...
// Skill range
	...
	if ($target_range == 'onlyone') {
		...
		if ($target_range_area_type == 'lightningbolt' ) {
			$skillrange = '<dl class="skillrange"><dt>Area Range'.$multipleTargets.'<br>rea</dt><dd class="cost" id="skill_range"><span align="center"><img src="https://aionpowerbook.com/powerbook/skins/MonoBook/img/lightningbolt.png" style="width:20px; height:20px" ></span><span align="center"> ' . $target_range_opt1 . 'x' . $target_range_opt2 . 'm</span></dd></dl>';
		}elseif ($target_range_area_type == 'fireball' ) {
			$skillrange = '<dl class="skillrange"><dt>Area Range'.$multipleTargets.'</dt><dd class="cost" id="skill_range"><span align="center"><img src="https://aionpowerbook.com/powerbook/skins/MonoBook/img/fireball.png" style="width:20px; height:20px" ></span><span align="center"> ' . $target_range_opt1 . 'm</span></dd></dl>';
		}elseif ($target_range_area_type == 'firestorm' ) {
			$skillrange = '<dl class="skillrange"><dt>Area Range'.$multipleTargets.'</dt><dd class="cost" id="skill_range"><span align="center"><img src="https://aionpowerbook.com/powerbook/skins/MonoBook/img/firestorm.png" style="width:19px; height:15px" ></span><span align="center"> ' . $target_range_opt1 . 'm</span></dd></dl>';
		}
	}elseif ($target_range == 'party') {
		if ($target_range_area_type == 'lightningbolt' ) {
			$skillrange = '<dl class="skillrange"><dt>Party Range'.$multipleTargets.'</dt><dd class="cost" id="skill_range"><span align="center"><img src="https://aionpowerbook.com/powerbook/skins/MonoBook/img/lightningbolt.png" style="width:20px; height:20px" ></span><span align="center"> ' . $target_range_opt1 . 'x' . $target_range_opt2 . 'm</span></dd></dl>';
		}elseif ($target_range_area_type == 'fireball' ) {
			$skillrange = '<dl class="skillrange"><dt>Party Range'.$multipleTargets.'</dt><dd class="cost" id="skill_range"><span align="center"><img src="https://aionpowerbook.com/powerbook/skins/MonoBook/img/fireball.png" style="width:20px; height:20px" ></span><span align="center"> ' . $target_range_opt1 . 'm</span></dd></dl>';
		}elseif ($target_range_area_type == 'firestorm' ) {
			$skillrange = '<dl class="skillrange" ><dt>Party Range'.$multipleTargets.'</dt><dd class="cost" id="skill_range"><span align="center"><img src="https://aionpowerbook.com/powerbook/skins/MonoBook/img/firestorm.png" style="width:19px; height:15px" ></span><span align="center"> ' . $target_range_opt1 . 'm</span></dd></dl>';
		}
	}
...
$final .= '<div class="hbody" style="width:450px !important"><div class="objects object_skill"><div class="head skill_basic '.$css.'"><dl class="basic">';
$final .= '<dd class="thumb">' . skillIconBuilder($skillicon_name, isClassic()) . '</dd>';
$final .= '<dt class="name" style="width:355px;" ><span class="all"></span><span id="skill_name"><a href="https://aionpowerbook.com/powerbook/Skill/' . $id . '">' . $localization . '</a></span></dt>' . $classname . '</dl></div>';
...
if ($desc != NULL) {
$final .= '<dl class="skill_desc"><dt>' . translate('STR_TOOLTIP_SKILL_DESC_LONG', $language) . '</dt><dd id="skill_descrption" string="' . $desc_long . '" >' .  $descfinal . $descmissmattch . '</dd></dl>';
$final .= '<dl class="skill_desc devdetails" style="display:none"><dt>Test</dt><dd id="skill_descrption">' . $desclong . '</dd></dl>';
}
if ($eudescription != NULL && $eudescription != $descfinal) {
$final .= '<dl class="skill_desc"><dt>6.2 ' . translate('STR_TOOLTIP_SKILL_DESC_LONG', $language) . '</dt><dd id="skill_descrption">' . $eudescription . '</dd></dl>' ;
}
$final .= $chargefinal;
$final .= $target;
$final .= $castingdelay;
