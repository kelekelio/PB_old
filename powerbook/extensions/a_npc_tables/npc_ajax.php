...
$minlevel = $_GET['lowerlevel'];
$maxlevel = $_GET['higherlevel'];
$lang = $_GET['lang'];
...
$sql.=" WHERE (level BETWEEN $minlevel and $maxlevel) ";
...
$sql = "SELECT id, disk_type, hpgauge_level, ui_type, stare_distance, search_".$language.", search_ko, level, hp, magical_skill_boost_resist, client_version, race_type ";
$sql.=" FROM client_npcs_monster ";
$sql.=" WHERE (level BETWEEN $minlevel and $maxlevel) ";
$sql.=" and (description != 'STR_NPC_NO_NAME') ";
...
if ($ui_type == 'trap') {
	...
	$nestedData[] = $row["id"]; 
	$nestedData[] = '<img class="thumb" src="https://aionpowerbook.com/npc/icon/' . $itemicon . '.png"  alt="">';
